...
public class ServletAdmin extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        CategVente uneCategVente = form.ajouterCategorie(request);
        ...
        if (form.getErreurs().isEmpty()){
            ...
            CategVenteDAO.ajouterCategorie(connection, uneCategVente);
            this.getServletContext().getRequestDispatcher("/vues/categorieConsulter.jsp" ).forward( request, response );
        }
        else
        { 
